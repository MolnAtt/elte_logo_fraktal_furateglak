...
namespace LogoKaresz
{
	public class Avatar
	{
		...
		public static Color[] színek = ((KnownColor[])Enum.GetValues(typeof(KnownColor))).Select(x => Color.FromKnownColor((KnownColor)x)).ToArray();
		public static Color[] erős_színek_fehérre = new Color[]
